...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        "Рост группы:\n"
        "/growthpack — Посты и ответы для привлечения\n"
        "/admin_pitch — Сообщения админам групп\n"
        "/promo_comment — Ответы в комментариях\n\n"
        "Мобильный режим:\n"
        "/today — Что сегодня\n"
        "/evening — Что вечером\n"
...
async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        "/imagepack — Картинки из черновиков\n"
        "/growthpack — Посты и ответы\n"
        "/admin_pitch — Админам групп\n"
        "/promo_comment — Ответ в комментариях\n"
